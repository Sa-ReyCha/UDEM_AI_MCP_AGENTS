...
python 01_mcp/server.py --transport http --host 0.0.0.0 --port 8000
```
...
npx @modelcontextprotocol/inspector .env_santi/bin/python 01_mcp/server.py
```
...
python3 01_mcp/server.py --transport http
